...
export class SLProductPage {
    ...
    constructor(page: Page) {
        this.page = page;
        this.titleHeader = page.locator('//div[@class="product_label" and contains(text(), "Products")]');
        this.itemsText = page.locator('.inventory_item div[class="inventory_item_label"] div[class="inventory_item_name"]');
        this.itemsButton = page.locator('button[class*="btn_primary btn_inventory"]');
